/*
 * PII-PALADIN - Browser Version
 *
 * index.browser.js: Core logic for PII censoring in browser environments.
 */
...
// In browser environments, models are expected to be served from the same origin.
...
// WASM files are expected to be served from the same origin.
    ...
    static async getInstance(progress_callback = null) {
        if (this.instance === null) {
            try {
                ...
                console.error(
                    "Please ensure model files are served from './models/Xenova/bert-base-NER/onnx/' and WASM files from './wasm/'.",
                );
                throw new Error(
